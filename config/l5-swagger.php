...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'VSM Mobile API Documentation',
            ],
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            // Corrige la TypeError : Passage à null pour laisser Swagger gérer l'analyseur
            'analyser' => null,
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                'bearerAuth' => [
                    'type' => 'apiKey',
                    'description' => 'Entrez votre jeton Sanctum sous la forme: Bearer {token}',
                    'name' => 'Authorization',
                    'in' => 'header',
                ],
            ],
